...
import {ConnectToBridge} from "../Components/ConnectToBridge.tsx";
...
export function LightControlContainer(){
    ...
    if(bridgeData?.hueData.connected){
    ...
    if(bridgeData?.hueData.connected == false){
        return (
            <ConnectToBridge/>
        )
    }
